...
import MapProviderToggle from '@/components/admin/MapProviderToggle';
...
export default function AdminMapsQA() {
  ...
  useEffect(() => {
    const t = setTimeout(() => update('map', { status: 'pass', detail: isGoogleMapsDisabled() ? 'OSM/Leaflet' : 'Google Maps' }), 1200);
      ...
      <div className="max-w-5xl mx-auto space-y-4">
        <header className="space-y-1">
          ...
          <p className="text-sm text-muted-foreground">
            Quick regression page for map, routing, search, and the OSM/Google kill switch.
          </p>
        </header>
